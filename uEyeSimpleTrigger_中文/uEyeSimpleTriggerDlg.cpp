...
void CuEyeSimpleTriggerDlg::SaveImage(){
	IMAGE_FILE_PARAMS ImageFileParams;
...
void CuEyeSimpleTriggerDlg::SaveImage(string nametemp){
	IMAGE_FILE_PARAMS ImageFileParams;
	wchar_t name[100];
	swprintf_s(name, 100, L"%S", nametemp.c_str());
	ImageFileParams.pwchFileName = name;
	ImageFileParams.pnImageID = NULL;
	ImageFileParams.ppcImageMem = NULL;
	ImageFileParams.nQuality = 100;
	ImageFileParams.nFileType = IS_IMG_BMP;
